      ...
      <ScrollView>
        <Container>
          ...
          <Item fixedLabel last style={{ marginTop: 20, marginBottom: 10 }}>
            <Label style={styles.MainText}>Add Skills</Label>
          </Item>
          <Item fixedLabel last style={styles.row}>
            <Input onChangeText={this.setData} bordered style={styles.startRouteBtn} placeholder="Please State Your Destination" />
          ...
          <View style={{ justifyContent: 'center', fontSize: 20 }}>
