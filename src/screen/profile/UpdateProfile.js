...
import { Container, Textarea, Label, Card, CardItem, Content, Footer, FooterTab, Button, Text, Item, Input, Left, Right, Header, Body } from 'native-base';
            ...
            <ScrollView>
                <Container>
                    ...
                    <Item fixedLabel last style={{ marginTop: 20, marginBottom: 10 }}>
                        <Label style={styles.MainText}>Edit Bio</Label>
                    </Item>
                    <Item fixedLabel last style={styles.row}>
                        <Textarea rowSpan={5} bordered style={styles.startRouteBtn} placeholder="Tell something about yourself Here" />
                    </Item>
